...
//recover data for first year (sessions up to second control)
...
//recover data for second year (sessions up to second control)
...
//recover data for third year (sessions up to second control)
...
$all_sessions_c2 = merge_array_data($avg_session_data, $calc_type);
...
$filename =  "control2-sesiones-" . $calc_type . ".csv";

array_to_csv_download(array($all_sessions_c2), $filename, $headers);
