...
$all_sessions_c1 = merge_array_data($avg_session_data, $calc_type);
...
$filename =  "control1-sesiones-" . $calc_type . ".csv";

array_to_csv_download(array($all_sessions_c1), $filename, $headers);
