...
<!--<script>
	...
	var barChartData = {
		...
		datasets : [
			{
				label: "Warnings",
				fillColor : "rgba(242,227,67,0.5)",
				strokeColor : "rgba(242,227,67,0.8)",
				highlightFill: "rgba(242,227,67,0.75)",
				highlightStroke: "rgba(242,227,67,1)",
				data : warnings
			},
			{
				label: "Errors",
	...
	var total_warnings = parseInt($('#total-warnings').html());
	var total_errors = parseInt($('#total-errors').html());
	var pieData = [
			{
