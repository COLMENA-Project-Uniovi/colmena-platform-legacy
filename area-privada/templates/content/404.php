...
<html>
	...
	<?php
		include($root_private_area_path. 'lib/functions/general-functions.php');
		include($root_private_area_path. 'lib/functions/lang-functions.php');
		include($root_private_area_path. 'lib/functions/familias-functions.php');
		include($root_private_area_path. 'lib/functions/asignaturas-functions.php');
