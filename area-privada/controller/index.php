...
if(!file_exists($root_private_area_path."templates/content/".$template.".php")){
	http_response_code(404);
	echo $root_private_area_path."templates/content/".$template.".php";	
	include_once ($root_private_area_path."templates/content/404.php");
	include_once ($root_private_area_path."templates/footer.php");
	exit();
}

//$page_title = ucfirst(str_replace('-', ' ',  $template));
include_once($root_private_area_path."templates/header.php"); 
include_once($root_private_area_path."templates/menu/menu-principal.php");

// especific content
include_once ($root_private_area_path."templates/content/".$template.".php"); 	
